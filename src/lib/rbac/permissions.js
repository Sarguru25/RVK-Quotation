...
export const DEFAULT_ROLES = {
  ...
  MANAGER: {
    name: "Manager",
    permissions: [
      PERMISSIONS.QUOTATION.CREATE, PERMISSIONS.QUOTATION.VIEW, PERMISSIONS.QUOTATION.EDIT, PERMISSIONS.QUOTATION.DELETE, PERMISSIONS.QUOTATION.SUBMIT, PERMISSIONS.QUOTATION.APPROVE, PERMISSIONS.QUOTATION.SEND, PERMISSIONS.QUOTATION.CONVERT_SO,
  ...
  EXECUTIVE: {
    name: "Executive",
    permissions: [
      PERMISSIONS.QUOTATION.CREATE, PERMISSIONS.QUOTATION.VIEW, PERMISSIONS.QUOTATION.EDIT, PERMISSIONS.QUOTATION.SUBMIT, PERMISSIONS.QUOTATION.SEND,
